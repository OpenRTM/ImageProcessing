  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  PerspectiveTest(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void PerspectiveTestInit(RTC::Manager* manager);
};

#endif // PERSPECTIVE_TEST_H
