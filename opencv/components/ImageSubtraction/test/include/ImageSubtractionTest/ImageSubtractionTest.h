...
#ifndef IMAGESUBTRACTION_TEST__H
#define IMAGESUBTRACTION_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ImageSubtractionTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~ImageSubtractionTest();
 ...
 protected:
  ...
  /*!
   */
  RTC::InPort<RTC::CameraImage> m_img_captureIn;
  RTC::CameraImage m_img_result;
  /*!
   */
  RTC::InPort<RTC::CameraImage> m_img_resultIn;
  ...
  /*!
   */
  RTC::InPort<RTC::CameraImage> m_img_thresholdIn;
...
extern "C"
{
  DLL_EXPORT void ImageSubtractionTestInit(RTC::Manager* manager);
};

#endif // IMAGESUBTRACTION_TEST_H
