...
static const char* imagesubtraction_spec[] =
  {
    "implementation_id", "ImageSubtraction",
    "type_name",         "ImageSubtraction",
...
const char* ImageSubtraction::mode_str[2] = {
...
//		size : 画像サイズ
//
void ImageSubtraction::initializeBackgroundModel(int num, cv::Size size, double thre_coefficient)
{
  int i;
 ...
 */
ImageSubtraction::ImageSubtraction(RTC::Manager* manager)
...
RTC::ReturnCode_t ImageSubtraction::onInitialize()
{
...
/*
RTC::ReturnCode_t ImageSubtraction::onFinalize()
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ImageSubtraction::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ImageSubtraction::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t ImageSubtraction::onActivated(RTC::UniqueId ec_id)
{
  ImageSubtraction_count = 0;
  g_temp_w = 0;
  g_temp_h = 0;
...
RTC::ReturnCode_t ImageSubtraction::onDeactivated(RTC::UniqueId ec_id)
{
...
RTC::ReturnCode_t ImageSubtraction::onExecute(RTC::UniqueId ec_id)
{	
  /* キー入力判定 */
  if(m_KeyIn.isNew())
  {
  ...
  /* 初期値を取得する */
  if(ImageSubtraction_count == 0 && m_img_origIn.isNew())
  {
    m_img_origIn.read();
    ...
    if(g_temp_w != m_img_orig.width || g_temp_h != m_img_orig.height)
    {
      ...
      ImageSubtraction_count = 1;
      g_temp_w = m_img_orig.width;
      g_temp_h = m_img_orig.height;
    }
  }

  if(ImageSubtraction_count == 1 && m_img_origIn.isNew())
  {
    m_img_origIn.read();
...
/*
RTC::ReturnCode_t ImageSubtraction::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ImageSubtraction::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ImageSubtraction::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ImageSubtraction::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t ImageSubtraction::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
extern "C"
{
  ...
  void ImageSubtractionInit(RTC::Manager* manager)
  {
    coil::Properties profile(imagesubtraction_spec);
    manager->registerFactory(profile,
                             RTC::Create<ImageSubtraction>,
                             RTC::Delete<ImageSubtraction>);
  }
