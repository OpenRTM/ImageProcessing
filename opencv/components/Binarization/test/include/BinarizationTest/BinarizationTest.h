...
#ifndef BINARIZATION_TEST__H
#define BINARIZATION_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  BinarizationTest(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void BinarizationTestInit(RTC::Manager* manager);
};

#endif // BINARIZATION_TEST_H
