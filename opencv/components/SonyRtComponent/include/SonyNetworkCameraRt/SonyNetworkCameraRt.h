...
#ifndef SONYNETWORKCAMERART_H
#define SONYNETWORKCAMERART_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SonyNetworkCameraRt(RTC::Manager* manager);
 ...
 private:
  ...
  openrtm_network_camera::sony::SonyNetworkCamera m_camera;  //!< SONYネットワークカメラクラス
};


extern "C"
{
  DLL_EXPORT void SonyNetworkCameraRtInit(RTC::Manager* manager);
};

#endif // SONYNETWORKCAMERART_H
