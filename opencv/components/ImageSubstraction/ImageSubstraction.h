  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  CameraImage m_img_capture;
  /*!
   */
  OutPort<CameraImage> m_img_captureOut;
  CameraImage m_img_result;
  /*!
   */
  OutPort<CameraImage> m_img_resultOut;
  CameraImage m_img_back;
  /*!
   */
  OutPort<CameraImage> m_img_backOut;
  CameraImage m_img_threshold;
  /*!
   */
  OutPort<CameraImage> m_img_thresholdOut;
